...
static void deploy_z_probe() {
     ...
     do_blocking_move_to_z(current_position[Z_AXIS] + Z_RAISE_BEFORE_PROBING); // this also updates current_position
      st_synchronize();
#endif
...
#if ENABLED(TRUE) || ENABLED(Z_PROBE_ALLEN_KEY) || ENABLED(Z_PROBE_SLED)

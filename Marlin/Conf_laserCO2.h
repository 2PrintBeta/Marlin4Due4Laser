...
#define LASER_INTENSITY_PIN 4 // S2
#define LASER_FIRING_PIN    32 // S1
#define LASER_SEVEN 0
#define HIGH_TO_FIRE
...
#define STRING_CONFIG_H_AUTHOR "(Wenger, CO2 laser)" // Who made the changes.
...
#define MOTHERBOARD BOARD_BAM_DICE_DUE
...
//#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 10.0   // Probe on: -front +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -1.0  // -below (always!)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.315,80.315,((360/7.5)*50*16)/5,880}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {80000, 80000, 2, 25}    // (mm/sec)
...
#define DEFAULT_ACCELERATION          15000    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  15000    // E acceleration in mm/s^2 for retracts
#define DEFAULT_TRAVEL_ACCELERATION   15000    // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves
